...
! function (e, i) {
    ...
    function i(i, t) {
        if (window.File && window.FileReader && window.FileList && window.Blob) {
            var s = {
                ...
                messages: {
                    "default": "Arrastrar Imagen, o hacer click para seleccionar desde las descargas",
                    replace: "Arrastrar Imagen, o hacer click para seleccionar desde las descargas",
                    remove: "Remover",
                    error: "Ooops, algo sucedió internamente"
                },
                error: {
                    fileSize: "Peso del archivo muy grande para el servidor ({{ value }} max).",
                    minWidth: "La resolución de la imagen es demasiado bajo ({{ value }}}px min).",
                    maxWidth: "El ancho de la imagen es demasiado grande ({{ value }}}px max).",
                    minHeight: "La altura de la imagen es demasiado bajo ({{ value }}}px min).",
                    maxHeight: "La altura de la imagen es demasiado grande ({{ value }}px max).",
                    imageFormat: "El formato de la imagen es incorrecto ({{ value }} only).",
    ...
    return i.prototype.onChange = function () {
        ...
        if (this.hideLoader(), i === !0) {
            var r = e("<img id='ImgFoto'/>").attr("src", t);
