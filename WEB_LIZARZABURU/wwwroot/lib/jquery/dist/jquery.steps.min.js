...
!function (a, b) {
    ...
    function L(a, b, c) {
        if (b.enablePagination) {
            var d = '<{0} class="actions {1}"><ul role="menu" aria-label="{2}">{3}</ul></{0}>',
                ...
                fi = '<li><a href="#{0}" class="btn-success"  role="menuitem" id="btnRegistrar">{1}</a></li>',
                f = "";
            b.forceMoveForward || (f += e.format("previous", b.labels.previous)),
                f += e.format("next", b.labels.next),
                b.enableFinishButton && (f += fi.format("finish", b.labels.finish)),
    ...
    var $ = a.fn.steps.contentMode = {
        ...
        cb = a.fn.steps.defaults = {
            ...
            ,
            labels: {
                cancel: "Cancel", current: "current step:", pagination: "Pagination", finish: "Registrar", next: "Siguiente", previous: "Anterior", loading: "Cargando ..."
            }
        }
}
